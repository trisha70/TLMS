...
<head>
  ...
  <title>Teacher Home - Lernix</title>
...
<body>
  ...
  <div class="main-content">
    <div class="teacher-home">
      <h2>Welcome Teacher <i class="ri-book-2-fill"></i></h2>

      <div class="home-grid">
        <a href="teacher_profile.jsp" class="home-card">
          <i class="ri-user-3-line"></i>
          <span>View Profile</span>
        </a>

        <a href="marks_entry.jsp" class="home-card">
          <i class="ri-edit-box-line"></i>
          <span>Marks Entry</span>
        </a>

        <a href="online_exam.jsp" class="home-card">
        ...
        <a href="assignment.jsp" class="home-card">
