    ...
    <div class="dashboard-container">
        <div class="dashboard-card">
            ...
            <div class="action-grid">
                ...
                <!-- 2. Notice Button (Bottom Left) -->
                <a href="addNotice.jsp" class="action-button">
                    <i class="ri-notification-3-line"></i>
                    Notice
                </a>
                
                <!-- 3. Update Button (Top Right) -->
                <a href="updateTeacher.jsp" class="action-button">
                    <i class="ri-pencil-line"></i>
                    Update Teacher
                </a>
                
                <!-- 4. Update Button (Top Right) -->
                <a href="updateStudent.jsp" class="action-button">
                    <i class="ri-edit-circle-line"></i>
                    Update Student
                </a>

                <!-- 5. Routine Button (Bottom Right) -->
                <a href="admin_routine_upload.jsp" class="action-button">
